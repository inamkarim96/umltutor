            ...
            <div className="main">
                ...
                <div className="topbar">
                    <div className="topbar-left">
                        <h1>Good {today.getHours() < 12 ? 'morning' : today.getHours() < 18 ? 'afternoon' : 'evening'}, {user?.firstName || user?.name || 'Student'} ≡ƒæï</h1>
                        <p>{dateString} ΓÇö You have {pendingAssignments.length} pending assignment{pendingAssignments.length !== 1 && 's'}</p>
                    </div>
                        ...
                        <div className="dash-main-col">
                            ...
                            <div className="panel">
                                <div className="panel-header">
                                    ...
                                    <div onClick={() => navigate('/student/classes')} className="panel-action">View All ΓåÆ</div>
                                </div>
                            ...
                            <div className="panel">
                                <div className="panel-header">
                                    ...
                                    <div onClick={() => navigate('/student/assignments')} className="panel-action">View All ΓåÆ</div>
                                </div>
