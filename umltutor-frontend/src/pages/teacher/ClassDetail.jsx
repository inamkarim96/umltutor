                        ...
                        <div className="bg-[#f1f5f9] px-8 py-6 rounded-3xl border border-white shadow-inner flex flex-col items-center min-w-[200px]">
                            ...
                            <div className="text-center space-y-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-black text-gray-800">{enrolledStudents.length}</p>
                                </div>
                                <div>
                        ...
                        <div className="space-y-3">
                            {enrolledStudents.length > 0 ? (
                                ...
                                <div className="text-center py-12">
                                    ...
                                    <p className="text-gray-400 text-sm mt-2">Click "Add Students" to enroll students in this class.</p>
                                </div>
                            )}
                        </div>
                    </div>
