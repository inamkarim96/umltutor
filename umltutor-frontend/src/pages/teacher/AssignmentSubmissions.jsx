        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50">
                <div className="text-center">
                    ...
                    <p className="text-gray-500 font-bold uppercase tracking-widest text-[10px]">Loading Submissions...</p>
                </div>
            </div>
        );
    }
                ...
                <div className="flex items-center gap-6">
                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-0.5">
                            <span className="px-2 py-0.5 bg-indigo-50 text-indigo-600 text-[10px] font-black rounded uppercase tracking-widest">Teacher View</span>
                        ...
                        <h1 className="text-xl font-black text-gray-900 leading-none">{assignment.title}</h1>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                    <div className="hidden md:flex items-center gap-8 mr-8">
                        <div className="text-right">
                            <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-0.5">Submissions</p>
                    ...
                    <button className="p-3 bg-gray-50 text-gray-400 rounded-2xl border border-gray-100 hover:bg-white hover:text-indigo-600 transition-all shadow-sm">
                        <Filter size={20} />
                    </button>
                </div>
            </div>
            ...
            <div className="px-8 py-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
                    <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm flex items-center gap-6">
                        ...
                        <div>
                            <p className="text-xs font-black text-gray-400 uppercase tracking-widest mb-1">Total Enrolled</p>
                    ...
                    <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm flex items-center gap-6">
                        ...
                        <div>
                            <p className="text-xs font-black text-gray-400 uppercase tracking-widest mb-1">Tutorial Requests</p>
                            <p className="text-3xl font-black text-gray-900">
                                    ...
                                    return visibleSubmissions.map((sub) => (
                                        <tr key={sub.studentId} className="group hover:bg-indigo-50/30 transition-all duration-300">
                                            ...
                                            <td className="px-10 py-8">
                                                <div className="flex">
                                                    ...
                                                    {sub.tutorialRequested && !sub.tutorialApproved && (
                                                        <span className="ml-3 px-3 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest shadow-sm border bg-amber-50 text-amber-600 border-amber-100">
                                                            Tutorial Req
                                                        </span>
                                                    )}
                                                </div>
                                            ...
                                            <td className="px-10 py-8 text-sm">
                                                <div className="flex items-center gap-3 text-gray-500 font-bold tabular-nums">
                                            ...
                                            <td className="px-10 py-8">
                                                {sub.status === 'graded' || sub.status === 'GRADED' ? (
                                                    <div className="flex items-baseline gap-1">
                                                        <span className="text-2xl font-black text-indigo-600">{sub.score}</span>
                                                        <span className="text-xs font-bold text-gray-300">/{sub.maxScore ?? '—'}</span>
                                                    </div>
                                                ) : (
