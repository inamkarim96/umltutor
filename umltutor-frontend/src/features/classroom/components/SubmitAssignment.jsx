        ...
        <div className="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 overflow-hidden">
            <div className="p-10 border-b border-gray-100 bg-gray-50/30">
                <div className="flex items-center gap-4 mb-2">
                    ...
                    <h2 className="text-2xl font-black text-gray-900 tracking-tight">Ready to Submit?</h2>
                </div>
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex flex-wrap gap-3 text-xs font-black uppercase tracking-widest">
                        {dueDate && (
                            <span className={`inline-flex items-center gap-2 px-4 py-2 rounded-2xl border ${
                                isPastDeadline ? 'bg-red-50 text-red-700 border-red-100' : 'bg-indigo-50 text-indigo-700 border-indigo-100'
                            }`}>
                                <Clock size={14} />
                        ...
                        {hasSubmitted && (
                            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-2xl border bg-emerald-50 text-emerald-700 border-emerald-100">
                                <CheckCircle size={14} />
                                Submitted {currentSubmission?.submittedAt ? new Date(currentSubmission.submittedAt).toLocaleString() : ''}
                            </span>
                        )}
                        {hasSubmitted && (
                            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-2xl border bg-gray-50 text-gray-700 border-gray-100">
                                <RefreshCcw size={14} />
                                Attempts {attempts}
                            </span>
                        )}
            ...
            <div className="p-10">
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div>
                        <label className="block text-sm font-black text-gray-700 mb-3 flex items-center gap-2 uppercase tracking-widest">
                        ...
                        <textarea
                            ...
                            className="w-full px-6 py-4 bg-gray-50 border border-gray-200 rounded-3xl focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 focus:bg-white transition-all text-gray-900 font-medium text-lg shadow-inner resize-none"
                        ></textarea>
                    </div>
                    ...
                    <div className="flex items-center gap-4 p-6 bg-blue-50 rounded-3xl border border-blue-100/50">
                        ...
                        <div className="text-sm">
                            <p className="font-black text-blue-900 uppercase tracking-tighter">Diagrams Included</p>
                            <p className="text-blue-600 font-bold opacity-80 uppercase tracking-widest text-[10px] mt-0.5">Your Use Case and SSD work will be attached</p>
                        </div>
                    </div>
                    ...
                    <button
                        ...
                        className={`w-full py-5 text-white font-black rounded-3xl shadow-xl transition-all flex items-center justify-center gap-3 uppercase tracking-widest text-sm relative overflow-hidden ${
