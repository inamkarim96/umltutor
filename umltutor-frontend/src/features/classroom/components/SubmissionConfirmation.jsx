    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="border-b border-black/10 p-6">
          <h2 className="text-2xl font-bold font-body text-ink">Submit Assignment</h2>
        ...
        <div className="p-6">
          {!isConfirmed ? (
            ...
            <div className="space-y-6">
              ...
              <div className="bg-surface-3 rounded-lg p-4">
                <h3 className="font-semibold text-ink mb-2">{assignment.title}</h3>
              ...
              {/* Submission Summary */}
              <div>
                <h3 className="font-semibold text-ink mb-3">Submission Summary</h3>
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-blue-50 rounded-lg p-3">
                    <div className="text-2xl font-bold font-body text-blue-600">{summary.progressPercentage}%</div>
                    <div className="text-sm text-blue-800">Progress</div>
                  </div>
                  <div className="bg-status-green/10 rounded-lg p-3">
                    <div className="text-2xl font-bold font-body text-status-green">
                      {summary.requirementsCompleted}/{summary.totalRequirements}
                    </div>
                    <div className="text-sm text-status-green">Requirements</div>
                  </div>
                  <div className="bg-purple-50 rounded-lg p-3">
                    <div className="text-2xl font-bold font-body text-purple-600">{summary.totalUseCases}</div>
                    <div className="text-sm text-purple-800">Use Cases</div>
                  </div>
                  <div className="bg-orange-50 rounded-lg p-3">
                    <div className="text-2xl font-bold font-body text-orange-600">{summary.timeSpent}m</div>
              ...
              {/* Detailed Checklist */}
              <div>
                <h3 className="font-semibold text-ink mb-3">What's Being Submitted</h3>
                <div className="space-y-2">
                  <div className="flex items-center gap-3 p-3 bg-white border border-black/10 rounded-lg">
                    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                      summary.diagramsCreated > 0 ? 'bg-status-green/100 border-status-green' : 'border-gray-300'
                    }`}>
                    ...
                    <div className="flex-1">
                      <div className="font-medium text-ink">Use Case Diagram</div>
                  ...
                  <div className="flex items-center gap-3 p-3 bg-white border border-black/10 rounded-lg">
                    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                      summary.completedDescriptions > 0 ? 'bg-status-green/100 border-status-green' : 'border-gray-300'
                    }`}>
                    ...
                    <div className="flex-1">
                      <div className="font-medium text-ink">Use Case Descriptions</div>
                      <div className="text-sm text-muted">
                  ...
                  <div className="flex items-center gap-3 p-3 bg-white border border-black/10 rounded-lg">
                    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                      summary.ssdsCreated > 0 ? 'bg-status-green/100 border-status-green' : 'border-gray-300'
                    }`}>
                    ...
                    <div className="flex-1">
                      <div className="font-medium text-ink">System Sequence Diagrams</div>
                      <div className="text-sm text-muted">
            ...
            <div className="space-y-6">
              <div className="text-center py-4">
                ...
                <h3 className="text-xl font-bold font-body text-ink">Are You Sure?</h3>
              ...
              <div className="bg-surface-3 rounded-lg p-4">
                <h4 className="font-medium text-ink mb-2">You're about to submit:</h4>
          ...
          {/* Error Message */}
          {submissionError && (
            <div className="bg-status-red/10 border border-status-red/20 rounded-lg p-4 mt-4">
        ...
        <div className="border-t border-black/10 p-6">
          <div className="flex justify-between">
            <button
              ...
              className="px-6 py-2 text-muted border border-gray-300 rounded-lg hover:bg-surface-3 disabled:opacity-50"
            >
