...
const submitAssignment = async (req, res) => {
  try {
    ...
    const submissionData = {
      ...
      classDiagram: req.body.classDiagram || workflowPayload?.classDiagramData || model.classDiagram,
      sequenceDiagram: req.body.sequenceDiagram || workflowPayload?.sequenceData || workflowPayload?.sequenceDiagram || model.sequenceDiagrams || model.sequenceDiagram,
